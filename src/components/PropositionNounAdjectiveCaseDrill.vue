...
import { addToHistory, history,  getRandomAdjective, getRandomNoun, streakCount, totalAttempts, getRandomProposition } from './drillUtils.js'
...
const caseName = computed(() => {
  return currentProposition.value.case
}) 
...
const submitAnswer = () => {
  ...
  totalAttempts.value++
  addToHistory(`${proposition.sk} ${noun.sk} ${adjective.sk}`, answer, correct, expected)
