...
// ---------------------------
// PLURAL NOUNS (pluralOnly) — instrumental plural
// ---------------------------
describe('Plural nouns — instrumental plural', () => {
  // neuter plural
  ...
  test('Instrumental plural forms', () => {
    expect(dvere.declinate(CASE, true).derived).toBe('dverami');
    expect(usta.declinate(CASE, true).derived).toBe('ústami');
    expect(ranajky.declinate(CASE, true).derived).toBe('raňajkami');
    expect(cestoviny.declinate(CASE, true).derived).toBe('cestovinami');
    expect(peniaze.declinate(CASE, true).derived).toBe('peniazmi');
  });
});
