...
describe("Present tense — Regular verbs", () => {
  test("robiť (-ať) singular/plural", () => {
    ...
    expect(regularVerbs.robit.conjugatePresent(Pronoun.YOU).derived).toBe(
      "robíš"
    );
    expect(regularVerbs.robit.conjugatePresent(Pronoun.HE).derived).toBe("robí");
    expect(regularVerbs.robit.conjugatePresent(Pronoun.WE).derived).toBe(
      "robíme"
    );
    expect(regularVerbs.robit.conjugatePresent(Pronoun.YOU_PL).derived).toBe(
      "robíte"
    );
...
describe("Present tense — Irregular verbs", () => {
  ...
  test.skip("ísť", () => {
    ...
    expect(irregularVerbs.ist.conjugatePresent(Pronoun.THEY).derived).toBe(
      "idú"
    );
  });
  ...
  test.skip("dať", () => {
    ...
    expect(irregularVerbs.dat.conjugatePresent(Pronoun.THEY).derived).toBe(
      "dajú"
    );
  });
});
